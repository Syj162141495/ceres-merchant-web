<template>
  <div class="tool-select-product">
    ...
    <div class="porListBox">
      <product-source-multiple :productData.sync='productData' v-if="productData.sourceType=='1'"></product-source-multiple>
      <product-source-category :productData.sync='productData' v-if="productData.sourceType=='2'"></product-source-category>
    </div>
  </div>
</template>
