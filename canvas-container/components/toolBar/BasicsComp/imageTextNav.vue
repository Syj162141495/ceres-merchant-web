<template>
  <div class="brandListTool">
          ...
          <div v-for="(item, index) in activeComponent.componentContent.imgTextData" :key="index" class="item">
            <div class="listItemBox">
              ...
              <div class="addBox" v-show="imgCurrent === index">
                ...
                <div @click="deleteItem(item, index)" class="deleteItem"><span class="iconfont">&#xe633;</span>删除导航</div>
              </div>
            </div>
          </div>
        </draggable>
    ...
    <div class="addImgBtn" v-if="activeComponent.componentContent.imgTextData.length < 5" @click="addImgText"><span class="iconfont">&#xe64a;</span>添加导航</div>
