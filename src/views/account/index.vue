  ...
  <div class="accont_Page">
    ...
    <el-card class="box-card">
        ...
        <div class="text_item">
          ...
          <div class="bankName">
            <div class="bankNumber">
              ...
              <div class="bankNumber_2">{{ bankArr.cardNumber }}</div>
            </div>
            <div class="bankNumber">
      ...
      <div v-else>
        ...
        <div class="text_item">
          ...
          <div class="leftImg">
            <img
              src="https://bszzx-static1-dev.dongpinbang.co m/media/images/00/00cf93d2e56a7eefd9aa284173d32703f43ee9bd.png"
              alt
            >
          </div>
          <!-- 银行图片 -->
    ...
    >
      ...
      >
        ...
        <el-form-item label="卡号" prop="cardNumber">
          <el-input v-model="card.cardNumber" maxlength="19" oninput="value=value.replace(/[^\d]/g,'')" />
        </el-form-item>
        <el-form-item label="银行" prop="bank">
        ...
        <el-form-item label="注册手机号" prop="phone">
          <el-input v-model="card.phone" oninput="value=value.replace(/[^\d]/g,'')" maxlength="11" style="width: 120px;" />
          <el-button
            class="sendCode"
            type="primary"
            :loading="codeloading"
