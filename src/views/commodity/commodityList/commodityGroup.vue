<template>
  <div class="commodityGroup padding">
      ...
      <div class="formSearch">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item class="tagCustomer" label="库存数量">
            <el-input v-model="formInline.minStock" /><span>至</span><el-input v-model="formInline.maxStock" />
          </el-form-item>
          <el-form-item class="tagCustomer" label="价格">
            <el-input v-model="formInline.minPrice" /><span>至</span><el-input v-model="formInline.maxPrice" />
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      groupData: {
        condition: null, // 满足条件 1-全部满足 2-任意满足
        conditions: [ // 筛选条件数组
          // {
      ...
      if (self.groupData.shopGroupId !== '' && self.groupData.shopGroupId !== null) {
        ...
        commodityListUpdate(self.groupData).then(res => {
          if (res.code === '') {
            ...
            self.$router.push({ name: 'commodityList' })
          } else {
            self.$message({
              message: res.message,
              type: 'error'
