    ...
    >
      ...
      <div class="tableBox">
        ...
        >
          ...
          <!-- <el-table-column prop="timeType" label="用券时间" align="center" show-overflow-tooltip >
            <template slot-scope="scope">
              <span v-if="scope.row.timeType==1">固定时间</span>
              <span v-if="scope.row.timeType==2">领券当日起几天内可用</span>
            </template>
          </el-table-column> -->
          <el-table-column prop="stockNumber" label="库存" align="center" show-overflow-tooltip />
          <el-table-column prop="number" align="center" label="赠券数" width="200">
            <template slot-scope="scope">
          ...
          <el-table-column label="操作" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
              <div class="btnList">
                <el-button type="text" @click="delCoupon(scope.row.shopCouponId)">删除</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  mounted() {
    ...
    this.shopOperateId = this.$route.query.shopOperateId
    if (this.shopOperateId) {
      console.log(this.shopOperateId, '111')
      this.getOperateInfo()
    }
  },
  methods: {
    ...
    selectCoupon() {
      ...
      // console.log(this.couponOption, 'this.couponOption')
    ...
    saveIdCouponList() {
      ...
      console.log(this.addForm.coupons.length, 'num')
      this.$message({
        message: '选择优惠券保存成功',
        type: 'success'
      })
