          ...
          >
            ...
            <div class="good_details">
              ...
              <div class="totalRefund">
                退款总金额：
                <span class="fontWeight">¥{{ item.total }}</span>
              </div>
            </div>
          </div>
        </div>
...
<!--              </p>-->
              <div class="proofBox" v-if="order.images.length !==0">
                <h3>买家举证图片:</h3>
                <div class="imgBox">
                  <el-image v-for="(item, index) of order.images" :src="item" :key="index" :preview-src-list="order.images" alt></el-image>
                </div>
              </div>
            </div>
          </div>
