  ...
  <div class="addGroupBuy">
    ...
    <div class="addGroupBuyBox">
      <div class="addGroupBuyTit">
        {{ addForm.priceId ? "修改定价捆绑活动" : "新增定价捆绑活动" }}
      </div>
      <el-form
        ref="ruleForm"
        class="formBox"
      ...
      >
        ...
        <el-form-item class="applyType" label="活动商品" prop="commodity">
          <span class="selectBtn" @click="chooseProduct"
            >请选择<i
              v-if="addForm.priceProducts.length !== 0"
              class="selectNum"
              >{{ addForm.priceProducts.length }}</i
            ></span
          >
              ...
              <el-table-column label="操作" show-overflow-tooltip>
                <template slot-scope="scope">
                  <div class="btnList">
                    ...
                    >
                      <el-button slot="reference" class="delCls" type="text"
                        >删除</el-button
                      >
                    </el-popconfirm>
                  </div>
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.priceId) {
      this.addForm.priceId = this.$route.query.priceId;
      console.log(this.addForm.priceId, "111");
      this.getPriceInfo();
    }
  },
  methods: {
