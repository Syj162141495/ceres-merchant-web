<template>
  <div class="addGroupBuy">
    ...
    <div class="addGroupBuyBox">
      <div class="addGroupBuyTit">{{ shopGroupWorkId ? '修改拼团活动' : '新增拼团活动' }}</div>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button @click="goToGroupBuy">取 消</el-button>
    </span>
    <!-- 新建分组弹框 -->
    <el-dialog
    ...
    >
      ...
      <div class="tableBox">
        ...
        >
          ...
          <el-table-column prop="workPrice" label="拼团价（元）" width="200">
...
export default {
  ...
  mounted() {
    this.getProList()
    this.shopGroupWorkId = this.$route.query.shopGroupWorkId
    if (this.shopGroupWorkId) {
      console.log(this.shopGroupWorkId, '111')
